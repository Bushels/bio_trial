...
**Test artifact:** `bio_trial.signups` id `3ef9f803-deb3-4117-a093-99d5f4a81da4` ("Test Farmer", AB, wheat, 10 ac) — created during T11 verification and retained for Phase 5/6/7 testing. T17 added `trial_fields` id `1d48513d-188b-4ae8-9211-039a71698c4d` ("NW Field (smoke test)", wheat) + two `trial_events` (application + yield=52) under it. T20 added a second field `c3e0c30a-3e28-41a6-a9ac-753178665388` ("SW Field (t20 test)", canola, 40 ac, foliar_spray) + `field_created` / observation / `soil_test` events plus a 15-byte PDF at `trial-uploads/3ef9f803…/2026-04-20T04-37-32-653Z-38229233-soil-test.pdf`. T23/T24 left the signup in `product_delivered_at = 2026-04-20 05:19:09+00` / `farmer_telegram_chat_id = NULL` state for further testing. Full cleanup at T26.
